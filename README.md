...
Sistema inteligente de procesamiento de documentos financieros argentinos con IA y arquitectura multi-tenant.

## ✨ Características Principales

- 🤖 **Clasificación Automática** con GPT-4o Vision
- 📊 **Extracción de Datos** especializada por tipo de documento (Facturas, Servicios, Impuestos, Tarjetas)
- ✅ **Validación Interactiva** con correcciones en tiempo real
- 🔄 **Sistema de Aprendizaje** que mejora con el feedback de usuarios
- 📈 **Dashboard Avanzado** con analytics, comparativas y alertas de vencimientos
- ☁️ **3 Integraciones Cloud**: Google Sheets, Microsoft OneDrive, Dropbox
- 📱 **Mobile-First** completamente responsive
- ⚡ **Worker Escalable** para procesamiento en paralelo
- 🔴 **Real-Time Updates** con Server-Sent Events
- 🎯 **Monitoreo Completo** con Sentry y métricas de performance

## 🚀 Deploy Rápido

Para deployar a producción con todas las integraciones configuradas:

👉 **[Ver Guía Completa de Deployment](./DEPLOYMENT_GUIDE.md)** 👈

La guía incluye configuración paso a paso de:
- Supabase (Base de datos)
- Upstash Redis (Cola)
- Google OAuth (Sheets)
- Microsoft OAuth (OneDrive/Excel)
- Dropbox OAuth
- Sentry (Monitoreo)
- Deploy a Vercel
